...
The bbPress Setting "Allow users to subscribe to forums and topics" must also be enabled for this to work.<br><a target="_blank" href="https://usestrict.net/2013/02/bbpress-notify-nospam/#subscriptions">Click here to learn more.</a>', 'bbPress_Notify_noSpam' ) ;?></span>
				...
				<label style="margin-left:2em;">
					...
					<?php checked( $stash->settings->forums_auto_subscribe_new_users ); ?> >
					       <?php _e( 'Automatically subscribe new users to all forums.', 'bbPress_Notify_noSpam' ) ; ?>
					       <br><br>
					       <span class="description" style="margin-left:2em;"><?php _e( 'Enabling this option will make it so that users get subscribed to all forums the moment that they\'re registered  They can unsubscribe from the forums later to stop receiving topic notifications.', 'bbPress_Notify_noSpam' ) ;?></span>
				</label>
